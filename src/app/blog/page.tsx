        ...
        <main className={'flex flex-col gap-8 px-5 pt-14'}>
           <span className={'font-granesta flex flex-col text-6xl text-brightOrange'}>-&gt; BLOG</span>
            ...
            <section className={'flex flex-col gap-6'}>
                ...
                free to see <a className={'text-brightRed underline italic cursor-pointer'}>my personal barsa.</a>
            </span>
                <div className={'flex flex-row gap-1'}>
                    ...
                    <div className={'p-3 bg-brightOrange/10 text-justify'}>
                        <span className={'italic text-grayLight'}>
                            <a className={'cursor-pointer underline'}>Barsa</a> it is a refferecent to the first Brazilian encyclopedia, distinguished for providing comprehensive knowledge that spanned from sciences to humanities. It became a significant reference for the dissemination of knowledge in Brazil.
                        </span>
                    </div>
